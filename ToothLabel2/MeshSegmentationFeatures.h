...
#define NUM_BINNING_TYPES_GD						6 //GD表示geogesic测地距离
...
const float ANGLES_SDF[NUM_ANGLES_SDF]			 = {ANGLE1_SDF, ANGLE2_SDF, ANGLE3_SDF}; //圆锥角的角度？
#define ANGLE_STEP									ANGLE2_SDF-ANGLE1_SDF
#define ROT_ANGLE_STEP								45.0f    // was 90  每个顶点发射8条射线
#define NUM_SDF_FEATURES_PER_ANGLE					6 // mean(sdf), mean2(sdf), mean4(sdf), meansqrt(sdf), meansqrtsqrt(sdf), median(sdf)
